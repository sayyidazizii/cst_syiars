	...
	Class AcctRescheduleCredit extends CI_Controller{
		...
		public function addcreditaccount(){
			...
			$data = array (
				...
				"credits_account_net_price"					=> $this->input->post('new_credits_account_last_balance_principal',true),
				"credits_account_financing"					=> $this->input->post('new_credits_account_last_balance_principal',true),
				"credits_account_margin"					=> $this->input->post('new_credits_account_last_balance_margin',true),
				"credits_account_principal_amount"			=> $this->input->post('new_credits_account_principal_amount',true),
				"credits_account_margin_amount"				=> $this->input->post('new_credits_account_margin_amount',true),
				"credits_account_payment_amount"			=> $this->input->post('new_credits_account_payment_amount',true),
				"credits_account_last_balance_principal"	=> $this->input->post('new_credits_account_last_balance_principal',true),
				"credits_account_last_balance_margin"		=> $this->input->post('new_credits_account_last_balance_margin',true),
			...
			if($this->AcctCreditAccount_model->updateAcctCreditAccount($data)){
				$datareschedule = array (
					...
					'credits_account_last_balance_principal_old'	=> $this->input->post('credits_account_last_balance_principal_old', true),
					'credits_account_last_balance_margin_old'		=> $this->input->post('credits_account_last_balance_margin_old', true),
					...
					'credits_account_last_balance_principal_new'	=> $data['credits_account_last_balance_principal'],
					'credits_account_last_balance_margin_new'		=> $data['credits_account_last_balance_margin'],
				...
				if($this->AcctCreditAccount_model->insertAcctCreditsAccountReschedule($datareschedule)){
					...
					$url='AcctRescheduleCredit/showdetail/'.$data['credits_account_id'];
					redirect($url);
				} else{

<?php
	Class AcctSavingsTransferMutation extends CI_Controller{
		...
		public function index(){
			...
			$data['main_view']['transferstatus']		= $this->configuration->TransferStatus();
		...
		public function filter(){
			...
			redirect('AcctSavingsTransferMutation');
		}
		...
		public function reset_data(){
			...
			$this->session->unset_userdata('savings_account_from_id');
			redirect('AcctSavingsTransferMutation/addAcctSavingsTransferMutation');
		}
		...
		public function addAcctSavingsAccountFrom(){
	        ...
	        foreach ($list as $savingsaccount) {
	            ...
	            $row[] = '<a href="'.base_url().'AcctSavingsTransferMutation/addAcctSavingsTransferMutation/'.$savingsaccount->savings_account_id.'" class="btn btn-info" role="button"><span class="glyphicon glyphicon-ok"></span> Select</a>';
	            $data[] = $row;
	        }
		...
		public function addAcctSavingsAccountTo(){
	        ...
	        foreach ($list as $savingsaccount) {
	            ...
	            $row[] = $savingsaccount->member_name;
	            $row[] = $savingsaccount->member_address;
	            $row[] = '<a href="'.base_url().'AcctSavingsTransferMutation/addAcctSavingsTransferMutation/'.$savings_account_from_id.'/'.$savingsaccount->savings_account_id.'" class="btn btn-info" role="button"><span class="glyphicon glyphicon-ok"></span> Select</a>';
	            $data[] = $row;
	        }
		...
		public function validationAcctSavingsTransferMutation(){
			...
			if($this->AcctSavingsTransferMutation_model->validationAcctSavingsTransferMutation($data)){
				...
				$this->session->set_userdata('message',$msg);
				redirect('AcctSavingsTransferMutation/printValidationAcctSavingsTransferMutation/'.$savings_transfer_mutation_id);
			}else{
				$msg = "<div class='alert alert-danger alert-dismissable'> 
						<button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>

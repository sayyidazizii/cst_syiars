	...
	Class AcctCreditsAccountPaidOff extends CI_Controller{
		...
		public function index(){
			...
			<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
			    ...
			    <tr>
			        <td><div style=\"text-align: left;font-size:12;font-weight:bold\">DAFTAR NASABAH PEMBIAYAAN YANG SUDAH LUNAS</div></td>		
			...
			<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
			    <tr>
			        ...
			        <td width=\"13%\"style=\"border-bottom: 1px solid black;border-top: 1px solid black\"><div style=\"text-align: right;font-size:10;\">MARGIN</div></td>
			        ...
			        <td width=\"13%\"style=\"border-bottom: 1px solid black;border-top: 1px solid black\"><div style=\"text-align: right;font-size:10;\">SALDO MARGIN</div></td>
			...
			foreach ($acctcreditspayment as $key => $val) {
				$tbl3 .= "
					<tr>
				        ...
				        <td width=\"13%\"><div style=\"text-align: right;\">".number_format($val['credits_account_margin_amount'], 2)."</div></td>
				        <td width=\"13%\"><div style=\"text-align: right;\">".number_format($val['credits_account_last_balace_principal'])."</div></td>
				        <td width=\"13%\"><div style=\"text-align: right;\">".number_format($val['credits_account_last_balace_margin'])."</div></td>
				    </tr>
				";

				$totalpokok 	+= $val['credits_account_principal_amount'];
				$totalmargin 	+= $val['credits_account_margin_amount'];

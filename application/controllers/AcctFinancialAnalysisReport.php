...
<?php
	Class AcctFinancialAnalysisReport extends CI_Controller{
		...
		public function filter(){
			...
			redirect('AcctFinancialAnalysisReport');
		}
		...
		public function processPrinting(){
			...
			$acctfinancialanalysisLCR	= $this->AcctFinancialAnalysisReport_model->getAcctFinancialAnalysisLCR();
			$acctfinancialanalysisCAR	= $this->AcctFinancialAnalysisReport_model->getAcctFinancialAnalysisCAR();
			$acctfinancialanalysisFDR	= $this->AcctFinancialAnalysisReport_model->getAcctFinancialAnalysisFDR();
			$acctfinancialanalysisBOPO	= $this->AcctFinancialAnalysisReport_model->getAcctFinancialAnalysisBOPO();
			        	...
			        	<td style=\"width: 50%\">	
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";	
								...
								if($total_account_amount1 == 0 && $total_account_amount2 == 0){
									...
									$RASIO_LCR = ($total_account_amount1 / $total_account_amount2) * 100;
								}
		       ...
		       ";
			    ...
			    $tblheader_FDR = "
			        	<td style=\"width: 50%\">	
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";	
								...
								if($total_account_amount1 == 0 && $total_account_amount2 == 0){
									...
									$RASIO_FDR = ($total_account_amount1 / $total_account_amount2) * 100;
								}
		        	...
		        	<td style=\"width: 50%\">	
		        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";	
		        			$tblitem_BOPO = "";
		        			foreach ($acctfinancialanalysisBOPO as $key => $val) {
								if($val['report_type1']	== 1){
									$last_balance1 = $this->AcctFinancialAnalysisReport_model->getLastBalance($val['account_id1'], $sesi['branch_id']);
							...
							if($total_account_amount1 == 0 && $total_account_amount2 == 0){
								...
								$RASIO_BOPO = ($total_account_amount1 / $total_account_amount2) * 100;
							}

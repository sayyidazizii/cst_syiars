<?php
	Class Transaction extends CI_Controller{
        ...
        public function paymentPPOBPulsaPrePaid(){
			...
			if($ppob_balance < $ppob_product_price){
                ...
                if($ppob_balance_company < $ppob_product_price){
                    ...
                    /* apikey = $2y$10$pIWLU8/X0m4GGTdkhWAaJOt/ivDhhmyH64kOq//0sbRCgbk8Gw71q
                    secretkey = $2y$10$vswAf9Tq78bbCCSf0Q99EuHzV5K67xGzGfJUS0Ld51XhJMKNMCvym */
                    ...
                    if($inquiry_data['code'] == 200){
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_remark'	            => 'trxID '.$inquiry_data['data']['trxID'].' VoucherSN '.$inquiry_data['data']['token'].' Nomor HP '.$inquiry_data['data']['nova'].' '.$ppobproduct['ppob_product_name'].' '.$ppobproduct['ppob_product_title'], 
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_status'	            => $ppob_transaction_status,
                            'created_id'				            => $data_post['member_id'],
                            'ppob_transaction_remark'	            => 'trxID '.$data_inquiry[0]['id_transaksi'].' VoucherSN VOUCHERSN Nomor HP '.$data_inquiry[0]['phone_number'].' '.$data_inquiry[0]['product_id'],
        ...
        public function paymentPPOBPLNPrePaid(){
            ...
            /* productPrice=20000&member_id=32887&member_name=NURKHOLISON%2C%20SE&id_pelanggan_pln=004000000001&nominalPLN=20000&adminPLN=2500&refID=45099062&id_transaksi=456&branch_id=2&savings_account_id=31016&savings_id=3 */
                ...
                if($ppob_balance_company < $totalnominal){
                    ...
                    if($inquiry_data['code'] == 200){
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_date'		            => date('Y-m-d'),
                            'ppob_transaction_status'	            => $ppob_transaction_status,
                            'ppob_transaction_remark'	            => 'ID Pelanggan '.$data_inquiry[0]['nova'].' Nama NAMA - Tarif/Daya TARIF/DAYA - ID. Transaksi '.$data_inquiry[0]['id_transaksi'].' - Nominal '.$data_inquiry[0]['nominal'].' - Token TOKEN - '.$inquiry_data['data']['message'],
                            'created_id'				            => $data_post['member_id'],
                            'created_on'				            => date('Y-m-d H:i:s')
                        );
        ...
        public function paymentPPOBPLNPostPaid(){
            ...
            /* $data_post = array(
                'member_id'                 => 32887,
                'member_name'               => "NURKHOLISON, SE",
                'id_pelanggan_pln'          => '530000000001',
                'totalTagihan'              => 302500,
                'refID'                     => '004212C9245F1BA43A77CEBD5CD5DA39',
                'id_transaksi'              => 417,
                'branch_id'                 => 2,
                'savings_account_id'        => 31016,
                'savings_id'                => 3,
                   ...
                   /*  $data_inquiry[0] = array (
                    ...
                    if($inquiry_data['code'] == 200){
                        ...
                        foreach($detilTagihan as $key => $val){
                            ...
                            /* inquiry_data Array ( [code] => 200 [status] => success [data] => Array ( [noReferensi] => 004212C9245F1BA43A77CEBD5CD5DA39 [subscriberID] => 530000000001 [productCode] => PLNPOSTPAIDB [namaPengguna] => SUBCRIBER NAME [tarif] => R1 [daya] => 1300 [lembarTagihanTotal] => [lembarTagihan] => 1 [detilTagihan] => Array ( [0] => Array ( [meterAwal] => 00080000 [meterAkhir] => 00080000 [periode] => 201608 [nilaiTagihan] => 300000 [denda] => 0 [admin] => 2500 [total] => 302500 [fee] => 2400 ) ) [totalTagihan] => 302500 [sales_vendor_fee_agen] => 1440 [sales_vendor_fee_member] => 240 ) ) */
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_remark'	            => 'ID Pelanggan '.$data_inquiry[0]['nova'].' Nama NAMA - Tarif/Daya TARIF/DAYA - ID. Transaksi '.$data_inquiry[0]['id_transaksi'].' - Nominal '.$data_inquiry[0]['nominal'].' - No. Ref NO. REF - '.$inquiry_data['data']['message'],
                            'created_id'				            => $data_post['member_id'],
                            'created_on'				            => date('Y-m-d H:i:s')
                        );
        ...
        public function paymentPPOBBPJS(){
            ...
            /* member_id=32887&member_name=NURKHOLISON%2C%20SE&totalTagihan=155500&refID=45384774&noVA=423423423424234234&jmlBulan=1&id_transaksi=813&branch_id=2&savings_id=3&savings_account_id=31016 */
			...
			if($ppob_balance < $totalTagihan){
                ...
                if($ppob_balance_company < $totalTagihan){
                    ...
                    /* inquiry_data Array ( [code] => 200 [status] => success [data] => Array ( [noReferensi] => 4FE0C3745FA240D795E093D7F3D26774 [nova] => 0000001436861946 [productCode] => BPJSKES [namaPengguna] => KETUT AGUNG LUHUR SUCIPTO [jumlahPeriode] => 01 [jumlahPeserta] => 3 [tagihan] => 153000 [admin] => 2500 [totalTagihan] => 155500 [sales_vendor_fee_agen] => 300.00 [sales_vendor_fee_member] => 600.00 ) ) */
                    ...
                    if($inquiry_data['code'] == 200){
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_status'	            => $ppob_transaction_status,
                            'ppob_transaction_remark'	            => 'ID Pelanggan 0000',
                            'ppob_transaction_remark'	            => 'No. VA '.$data_inquiry[0]['nova'].' Nama NAMA Jumlah Peserta JUMLAH PESERTA Jumlah Periode '.$data_inquiry[0]['jumlah_bulan'].' No. Referensi '.$data_inquiry[0]['id_transaksi'],
                            'created_id'				            => $data_post['member_id'],
                            'created_on'				            => date('Y-m-d H:i:s')
                        );
        ...
        public function paymentPPOBTopup(){
            ...
            /* member_id=32887&member_name=NURKHOLISON%2C%20SE&id_pelanggan=53299384993&productCode=DANA10&productPrice=11225&productDefaultPrice=10950&id_transaksi=670&branch_id=2&ppob_product_fee=125.00&ppob_product_commission=150.00&savings_account_id=31016&savings_id=3 */

            /* $data_post                  = array(
                'ppob_product_code' 		    => 'DANA10',
                'ppob_agen_id'				    => 32887,
                'ppob_product_price' 		    => 11225,
                'ppob_product_default_price'    => 10950,
                'ppob_product_fee'              => 125,
                'ppob_product_commission'       => 150,
                'member_id'				        => 32887,
                'member_name'		        	=> 'NURKHOLISON',
                'branch_id'                     => 2,
                'savings_account_id'            => 31016,
                'savings_id'                    => 3,
                'id_pelanggan'                  => '53299384993',
                'productCode'                   => 'DANA10',
                'id_transaksi'                  => 670,
            ); */
                ...
                if($ppob_balance_company < $ppob_product_price){
                    ...
                    if($inquiry_data['code'] == 200){
                        ...
                        $datappob_transaction = array (
                            ...
                            'ppob_transaction_status'	            => $ppob_transaction_status,
                            'created_id'				            => $this->input->post('member_id',true),
                            'ppob_transaction_remark'	            => 'trxID '.$data_inquiry[0]['id_transaksi'].' Voucher Code VOUCHERCODE ID Pelanggan '.$data_inquiry[0]['nova'].' '.$ppobproduct['ppob_product_name'].' '.$ppobproduct['ppob_product_title'].'Product Code '.$data_inquiry[0]['productCode'],
                            'created_on'				=> date('Y-m-d H:i:s')
                        );
                        ...
                        $response['error_paymenttopupemoney'] 	= FALSE;
                        $response['error_msg_title'] 			= "Confirm";
                        $response['error_msg'] 					= $inquiry_data['text'];
                    }
                }
			}

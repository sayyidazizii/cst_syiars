		...
		public function processPrinting(){
			...
			if($sesi['kelompok_laporan_simpanan_berjangka'] == 0){
				...
				foreach ($acctdeposito as $kSavings => $vSavings) {
					$acctdepositoaccount_deposito = $this->AcctDepositoAccountClosedReport_model->getAcctDepositoAccountClosed_Deposito($sesi['start_date'], $sesi['end_date'], $vSavings['deposito_id'], $branch_id);

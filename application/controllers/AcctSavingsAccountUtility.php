<?php
	Class AcctSavingsAccountUtility extends CI_Controller{
		...
		public function filter(){
			...
			redirect('AcctSavingsAccountUtility');
		}
		...
		public function getAcctSavingsAccountUtilityList(){
	        ...
	        foreach ($list as $savingsaccount) {
	            ...
	            if($savingsaccount->validation == 0){
	            	$row[] = '<a href="'.base_url().'AcctSavingsAccountUtility/printNoteAcctSavingsAccountUtility/'.$savingsaccount->savings_account_id.'" class="btn btn-xs blue" role="button"><i class="fa fa-print"></i> Kwitansi</a>
				        <a href="'.base_url().'AcctSavingsAccountUtility/validationAcctSavingsAccountUtility/'.$savingsaccount->savings_account_id.'" class="btn btn-xs green-jungle" role="button"><i class="fa fa-check"></i> Validasi</a>';
		...
		public function filtermasterdata(){
			...
			redirect('AcctSavingsAccountUtility/getMasterDataSavingsAccount');
		}
		...
		public function reset_data(){
			...
			redirect('AcctSavingsAccountUtility/addAcctSavingsAccountUtility');
		}
		...
		public function getListCoreMember(){
	        ...
	        foreach ($list as $customers) {
	            ...
	            $row[] = '<a href="'.base_url().'AcctSavingsAccountUtility/addAcctSavingsAccountUtility/'.$customers->member_id.'" class="btn btn-info" role="button"><span class="glyphicon glyphicon-ok"></span> Select</a>';
	            $data[] = $row;
	        }
		...
		public function validationAcctSavingsAccountUtility(){
			...
			if($this->AcctSavingsAccountUtility_model->validationAcctSavingsAccountUtility($data)){
				...
				$this->session->set_userdata('message',$msg);
				redirect('AcctSavingsAccountUtility/printValidationAcctSavingsAccountUtility/'.$savings_account_id);
			}else{
				$msg = "<div class='alert alert-danger alert-dismissable'> 
						<button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>

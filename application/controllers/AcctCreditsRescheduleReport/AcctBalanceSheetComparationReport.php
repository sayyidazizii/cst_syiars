...
<?php
	...
	Class AcctBalanceSheetComparationReport extends CI_Controller{
		public function __construct(){
			parent::__construct();
			$this->load->model('Connection_model');
			$this->load->model('MainPage_model');
			$this->load->model('AcctBalanceSheetComparationReport_model');
		...
		public function index(){
			...
			$sesi	= 	$this->session->userdata('filter-AcctBalanceSheetComparationReport');
			...
			$data['main_view']['corebranch']								= create_double($this->AcctBalanceSheetComparationReport_model->getCoreBranch(),'branch_id','branch_name');

			$data['main_view']['acctbalancesheetcomparationreport_left']	= $this->AcctBalanceSheetComparationReport_model->getAcctBalanceSheetComparationReport_Left();

			$data['main_view']['acctbalancesheetcomparationreport_right']	= $this->AcctBalanceSheetComparationReport_model->getAcctBalanceSheetComparationReport_Right();

			$data['main_view']['accountcomparationreporttype']				= $this->configuration->AccountComparationReportType();

			$data['main_view']['content']									= 'AcctBalanceSheetComparationReport/AcctBalanceSheetComparationReport_view';
		...
		public function filter(){
			...
			$this->session->set_userdata('filter-AcctBalanceSheetComparationReport',$data);
			redirect('AcctBalanceSheetComparationReport');
		}

		public function processPrinting(){
			$preferencecompany 		= $this->AcctBalanceSheetComparationReport_model->getPreferenceCompany();
			...
			$acctbalancesheetcomparationreport_left	= $this->AcctBalanceSheetComparationReport_model->getAcctBalanceSheetComparationReport_Left();

			/*print_r("acctbalancesheetcomparationreport_left ");
			print_r($acctbalancesheetcomparationreport_left);
			exit;*/

			$acctbalancesheetcomparationreport_right	= $this->AcctBalanceSheetComparationReport_model->getAcctBalanceSheetComparationReport_Right();
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";
			        			...
			        			foreach ($acctbalancesheetcomparationreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 3){
										$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($valLeft['account_id1'], $month_before, $year_before, $sesi['account_comparation_report_type'], $sesi['branch_id']);		
									...
									$tblitem_beforeleft .= $tblitem_beforeleft1.$tblitem_beforeleft2.$tblitem_beforeleft3.$tblitem_beforeleft5;
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";		
			        			...
			        			foreach ($acctbalancesheetcomparationreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2']	== 3){
										$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($valRight['account_id2'], $month_before, $year_before, $sesi['account_comparation_report_type'], $sesi['branch_id']);
			        	...
			        	<td style=\"width: 25%\">	
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";
			        			...
			        			foreach ($acctbalancesheetcomparationreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 3){
										$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($valLeft['account_id1'], $month_now, $year_now, $sesi['account_comparation_report_type'], $sesi['branch_id']);		
									...
									$tblitem_nowleft .= $tblitem_nowleft1.$tblitem_nowleft2.$tblitem_nowleft3.$tblitem_nowleft5;
			        	...
			        	<td style=\"width: 25%\">	
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";		
			        			...
			        			foreach ($acctbalancesheetcomparationreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2']	== 3){
										$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($valRight['account_id2'], $month_now, $year_now, $sesi['account_comparation_report_type'], $sesi['branch_id']);
			    	...
			    	<td style=\"width: 25%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
			    			<tr>
								...
								<td style=\"width: 43%; text-align:right;\"><div style=\"font-weight:".$report_bold1."; font-size:12px\">".number_format($total_account_amount1_before_left, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    	<td style=\"width: 25%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
			    			<tr>
								...
								<td style=\"width: 43%; text-align:right;\"><div style=\"font-weight:".$report_bold2."; font-size:12px\">".number_format($total_account_amount2_before_right, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    	<td style=\"width: 25%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
			    			<tr>
								<td style=\"width: 55%\"><div style=\"font-weight:".$report_bold1.";font-size:12px\">".$report_tab1."".$valLeft['account_name1']."</div></td>
								<td style=\"width: 43%; text-align:right;\"><div style=\"font-weight:".$report_bold1."; font-size:12px\">".number_format($total_account_amount1_now_left, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    	<td style=\"width: 25%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
			    			<tr>
								<td style=\"width: 55%\"><div style=\"font-weight:".$report_bold2.";font-size:12px\">".$report_tab2."".$valRight['account_name2']."</div></td>
								<td style=\"width: 43%; text-align:right;\"><div style=\"font-weight:".$report_bold2."; font-size:12px\">".number_format($total_account_amount2_now_right, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    </tr>
		...
		public function exportAcctBalanceSheetComparationReport(){
			$auth 	= $this->session->userdata('auth');
			...
			if(!empty($acctbalancesheetcomparationreport_left && $acctbalancesheetcomparationreport_right)){
					...
					if(is_numeric($keyLeft)){
						...
						if($valLeft['report_type1'] == 5){
							if(!empty($valLeft['report_formula1']) && !empty($valLeft['report_operator1'])){
								...
								$this->excel->getActiveSheet()->setCellValue('F'.$j, $report_tab1.$valLeft['account_name1']);
								$this->excel->getActiveSheet()->setCellValue('G'.$j, $report_tab1.$total_account_amount1);
				...
				$this->excel->getActiveSheet()->setCellValue('C'.$total_row, $report_tab1.$grand_total_account_amount1_before);

				$this->excel->getActiveSheet()->setCellValue('D'.$total_row, $report_tab2.$valRight['account_name2']);
				$this->excel->getActiveSheet()->setCellValue('E'.$total_row, $report_tab2.$grand_total_account_amount2_before);

				$this->excel->getActiveSheet()->setCellValue('F'.$total_row, $report_tab1.$valLeft['account_name1']);
				$this->excel->getActiveSheet()->setCellValue('G'.$total_row, $report_tab1.$grand_total_account_amount1_now);

				$this->excel->getActiveSheet()->setCellValue('H'.$total_row, $report_tab2.$valRight['account_name2']);
				$this->excel->getActiveSheet()->setCellValue('I'.$total_row, $report_tab2.$grand_total_account_amount2_now);

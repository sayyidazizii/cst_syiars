<?php
	class AcctSavingsCloseBook_model extends CI_Model {
		...
		public function updateAcctSavingsAccount($branch_id){
			$query = $this->db->query("update acct_savings_account set savings_account_opening_balance = savings_account_last_balance, savings_account_daily_average_balance = 0 where branch_id = '".$branch_id."'");
		...
		public function insertAcctSavingsAccountDetail($data){
			return $query = $this->db->insert_batch('acct_savings_account_detail',$data);
		}

<?php
	class AcctDeposito_model extends CI_Model {
		...
		public function getDataAcctDeposito(){
			$this->db->select('acct_deposito.deposito_id, acct_deposito.deposito_code, acct_deposito.deposito_name, acct_deposito.account_id, acct_account.account_code, acct_account.account_name, acct_deposito.account_basil_id, acct_deposito.deposito_period, acct_deposito.deposito_interest_rate, acct_deposito.deposito_profit_sharing');

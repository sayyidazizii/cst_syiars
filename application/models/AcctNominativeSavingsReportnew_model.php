<?php
	class AcctNominativeSavingsReportnew_model extends CI_Model {
		...
		public function getAcctNomintiveSavingsReport($start_date, $branch_id){
		...
		public function getAcctNomintiveSavingsReport_Savings($start_date, $savings_id, $branch_id){
			$this->db->select('acct_savings_account.savings_account_id, acct_savings_account.savings_account_no, acct_savings_account.member_id, core_member.member_name, core_member.member_address, acct_savings_account.savings_account_date, acct_savings_account.savings_account_last_balance, acct_savings_account.savings_id, acct_savings.savings_name, acct_savings.savings_status');
			$this->db->from('acct_savings_account');
			$this->db->join('acct_savings', 'acct_savings_account.savings_id = acct_savings.savings_id');
			$this->db->join('core_member', 'acct_savings_account.member_id = core_member.member_id');
		...
		public function getAcctSavingsProfitSharing($savings_account_id, $period){
		...
		public function getAcctSavingsAccountDetail($savings_account_id){
			$this->db->select('acct_savings_account_detail.savings_account_detail_id, acct_savings_account_detail.branch_id, acct_savings_account_detail.savings_account_id, acct_savings_account_detail.savings_id, acct_savings_account_detail.mutation_id, acct_savings_account_detail.member_id, acct_savings_account_detail.today_transaction_date, acct_savings_account_detail.yesterday_transaction_date,  acct_savings_account_detail.transaction_code, acct_savings_account_detail.opening_balance, acct_savings_account_detail.mutation_in, acct_savings_account_detail.mutation_out, acct_savings_account_detail.last_balance,');
		...
		public function getTotalMutation($savings_account_id){
			$this->db->select('sum(mutation_in) as total_mutation_in , sum(mutation_out) as total_mutation_out');
			$this->db->from('acct_savings_account_detail');
			$this->db->where('acct_savings_account_detail.savings_account_id', $savings_account_id);
	    ...
	    {
	       $this->db->select('acct_savings_account.savings_account_id, acct_savings_account.savings_account_no, acct_savings_account.member_id, core_member.member_name, core_member.member_address, core_member.member_status, acct_savings_account.savings_account_date, acct_savings_account.savings_account_last_balance, acct_savings_account.savings_id, acct_savings.savings_name, acct_savings.savings_status');
			$this->db->from('acct_savings_account');
			$this->db->join('acct_savings', 'acct_savings_account.savings_id = acct_savings.savings_id');
			$this->db->join('core_member', 'acct_savings_account.member_id = core_member.member_id');

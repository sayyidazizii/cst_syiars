<?php
	class AcctSavingsProfitSharing_model extends CI_Model {
		...
		public function getSavingsProfitSharingToken($savings_profit_sharing_token){
			$this->db->select('savings_profit_sharing_token');
			$this->db->from('acct_savings_profit_sharing');
			$this->db->where('savings_profit_sharing_token', $savings_profit_sharing_token);
			return $this->db->get();
		}
		...
		public function getAcctSavingsProfitSharingLog_Detail($branch_id, $savings_id, $period){
			...
			$this->db->where('acct_savings_profit_sharing_log.branch_id', $branch_id);
			$this->db->where('acct_savings_profit_sharing_log.savings_profit_sharing_period', $period);
			$this->db->order_by('acct_savings_profit_sharing_log.savings_profit_sharing_log_id', 'DESC');
			$this->db->limit(1);
			return $this->db->get()->row_array();

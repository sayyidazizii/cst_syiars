<?php
	class AcctSavingsDailyAverageBalanceReport_model extends CI_Model {
		...
		public function getAcctSavingsDailyAverageBalance($period){
		...
		function get_datatables($period, $branch_id, $savings_id)
	    {
	        $this->_get_datatables_query($period, $branch_id, $savings_id);
	    ...
	    function count_filtered($period, $branch_id, $savings_id)
	    {
	        $this->_get_datatables_query($period, $branch_id, $savings_id);
	        $query = $this->db->get();
	    ...
	    public function count_all($period, $branch_id, $savings_id)
	    {	
	    	$this->db->select('acct_savings_profit_sharing.savings_account_id, acct_savings.savings_name, acct_savings_account.savings_account_no, acct_savings_profit_sharing.member_id, core_member.member_name, acct_savings_profit_sharing.savings_profit_sharing_amount, acct_savings_profit_sharing.savings_account_last_balance');
			$this->db->from('acct_savings_profit_sharing');
			$this->db->join('core_member', 'acct_savings_profit_sharing.member_id = core_member.member_id');
			$this->db->join('acct_savings_account', 'acct_savings_profit_sharing.savings_account_id = acct_savings_account.savings_account_id');
			$this->db->join('acct_savings', 'acct_savings_profit_sharing.savings_id = acct_savings.savings_id');
			...
			if($savings_id != 0){
				$this->db->where('acct_savings_profit_sharing.savings_id', $savings_id);
			}
			
	        return $this->db->count_all_results();
	    }

		private function _get_datatables_query($period, $branch_id, $savings_id)
	    {
			...
			$this->db->order_by('acct_savings_profit_sharing.savings_daily_average_balance', 'DESC');
			// $this->db->limit(50);

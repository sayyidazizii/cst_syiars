<?php
	class AcctLedgerReport_model extends CI_Model {
		...
		public function getMutationIn($account_id, $start_date, $end_date, $branch_id){
			$this->db->select('SUM(acct_account_balance_detail.account_in) AS mutation_in');
			$this->db->from('acct_account_balance_detail');
			$this->db->where('acct_account_balance_detail.account_id', $account_id);
			$this->db->where('acct_account_balance_detail.branch_id', $branch_id);
			$this->db->where('acct_account_balance_detail.transaction_date >= ', $start_date);
			...
			return $result['mutation_in'];
		}

		public function getMutationOut($account_id, $start_date, $end_date, $branch_id){
			$this->db->select('SUM(acct_account_balance_detail.account_out) AS mutation_out');
			$this->db->from('acct_account_balance_detail');
			$this->db->where('acct_account_balance_detail.account_id', $account_id);
			$this->db->where('acct_account_balance_detail.branch_id', $branch_id);
			$this->db->where('acct_account_balance_detail.transaction_date >= ', $start_date);

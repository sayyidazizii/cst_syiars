<?php
	class AcctJournalVoucher_model extends CI_Model {
		...
		public function voidAcctJournalVoucher($data){
			$this->db->where('acct_journal_voucher.journal_voucher_id', $data['journal_voucher_id']);
			if($this->db->update('acct_journal_voucher', $data)){
				return true;
			} else {
				return false;
			}
		...
		public function voidAcctJournalVoucherItem($data){
			$this->db->where('acct_journal_voucher_item.journal_voucher_item_id', $data['journal_voucher_item_id']);
			if($this->db->update('acct_journal_voucher_item', $data)){
				// print_r("sukses ");

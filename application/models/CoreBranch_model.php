<?php
	class CoreBranch_model extends CI_Model {
		...
		public function getDataCoreBranch(){
			$this->db->select('branch_id, branch_code, branch_name, branch_city, branch_address, branch_contact_person, branch_email, branch_phone1, branch_phone2, branch_manager, branch_no_sk');
		...
		public function getCoreBranch_Detail($branch_id){
			$this->db->select('branch_id, branch_code, branch_name, branch_city, branch_address, branch_contact_person, branch_email, branch_phone1, branch_phone2, account_rak_id, account_aka_id, branch_manager, branch_no_sk');
			$this->db->from('core_branch');
			$this->db->where('branch_id', $branch_id);

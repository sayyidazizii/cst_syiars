<?php
	Class AcctRecalculatePHU_model extends CI_Model{
		...
		public function getBagiHasilAnggota(){
			$this->db->select('bagi_hasil_anggota.member_id, bagi_hasil_anggota.branch_id, bagi_hasil_anggota.member_no, bagi_hasil_anggota.member_name, bagi_hasil_anggota.member_address, bagi_hasil_anggota.bagi_hasil, bagi_hasil_anggota.account_id, bagi_hasil_anggota.account_default_status, bagi_hasil_anggota.savings_id, bagi_hasil_anggota.savings_name, bagi_hasil_anggota.savings_account_id, bagi_hasil_anggota.savings_account_no, bagi_hasil_anggota.account_id_from, bagi_hasil_anggota.account_default_status_from, bagi_hasil_anggota.savings_id_from, bagi_hasil_anggota.savings_account_id_from');
			$this->db->from('bagi_hasil_anggota');
			$result = $this->db->get()->result_array();
			return $result;
		}

		public function insertAcctSavingsTransferMutation($data){
			if($this->db->insert('acct_savings_transfer_mutation', $data)){
				return true;
			} else {
				return false;
			}
		...
		public function getSavingsTransferMutationID($created_id){
		...
		public function getSavingsAccountOpeningBalance($savings_account_id){
			$this->db->select("acct_savings_account.savings_account_last_balance");
		...
		public function insertAcctSavingsTransferMutationTo($data){
			if($this->db->insert('acct_savings_transfer_mutation_to', $data)){
				return true;
			} else {
				return false;
			}
		...
		public function insertAcctRecalculatePHULog($data){

<?php
	class AcctCredits_model extends CI_Model {
		...
		public function getDataAcctCredits(){
			$this->db->select('acct_credits.credits_id, acct_credits.credits_code, acct_credits.credits_name, acct_credits.receivable_account_id, acct_credits.income_account_id');

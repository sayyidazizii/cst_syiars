...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctProfitLossReportNew">
...
<?php echo form_open('AcctProfitLossReportNew/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">	
		...
		<div class="portlet box blue">
			<div class="portlet-body">
				...
				<div class="form-body form">
						...
						<br>
						<?php
							echo form_open('AcctProfitLossReportNew/processPrinting'); 

							$preferencecompany = $this->AcctProfitLossReportNew_model->getPreferenceCompany();
														...
														foreach ($acctprofitlossreport_top as $key => $val) {
															...
															echo "
																...
																if($val['report_type']	== 3){
																	$account_subtotal 	= $this->AcctProfitLossReportNew_model->getAccountAmount($val['account_id'], $data['month_period'], $data['year_period'], $data['profit_loss_report_type'], $data['branch_id']);
					...
					<div class="row">
						<div class="col-md-12 " style="text-align  : right !important;">
							...
							<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctProfitLossReportNew/exportAcctProfitLossReportNew","_blank","top=100,left=200,width=300,height=300"));' title="Export to Excel" class="btn blue"><i class="fa fa-print"></i> Export Data  </a>
						</div>
					</div>
				</div>
			</div>

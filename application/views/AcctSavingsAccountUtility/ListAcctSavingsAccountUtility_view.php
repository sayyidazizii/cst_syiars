...
<h3 class="page-title">
	Master Data Simpanan <small>Kelola Master Data Simpanan</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctSavingsAccountUtility/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsAccountUtility/addAcctSavingsAccountUtility" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Input Rekening Simpanan Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsAccountUtility/getAcctSavingsAccountUtilityList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

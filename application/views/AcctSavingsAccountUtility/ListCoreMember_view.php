...
<script type="text/javascript">
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>AcctSavingsAccount/getCoreKecamatan",
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccount/getListCoreMember">
				Data Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('AcctSavingsAccount/filterListCoreMember',array('id' => 'myform', 'class' => '')); ?>
								...
								foreach ($coremember as $key=>$val){									
									echo"
										<tr>			
											...
											<td>".$val['member_mother']."</td>
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsAccount/addAcctSavingsAccount/'.$val['member_id']."' class='btn default btn-xs blue'>

...
<script>
	...
	$(document).ready(function(){
	 ...
	 function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctSavingsAccountUtility/function_elements_add');?>",
	...
	function reset_data(){
		document.location = base_url+"AcctSavingsAccountUtility/reset_data";
	}
	 ...
	 $(document).ready(function(){
		 $('#savings_id').combobox({
			  onChange: function(value){
			   ...
			   $.post(base_url + 'AcctSavingsAccountUtility/getSavingsAccountNo',
...
<?php echo form_open('AcctSavingsAccountUtility/processAddAcctSavingsAccountUtility',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccountUtility">
				Daftar Rekening Simpanan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccountUtility/addAcctSavingsAccountUtility">
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctSavingsAccountUtility" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsAccountUtility/getListCoreMember')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccountOfficerReport">
				Daftar Nasabah Simpanan Per BO
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<?php	echo form_open('AcctSavingsAccountOfficerReport/processPrinting',array('id' => 'myform', 'class' => ''));  

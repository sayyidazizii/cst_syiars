...
<script>
	...
	function reset_edit(){
		document.location = base_url+"CoreMember/reset_edit_member/<?php echo $coremember['member_id']?>";
	}
	...
	$(document).ready(function(){
		 $('#mutation_id').combobox({
			  onChange: function(value){
			   ...
			   $.post(base_url + 'CoreMember/getMutationFunction',
...
<?php echo form_open('CoreMember/processEditCoreMemberSavings',array('id' => 'myform', 'class' => 'horizontal-form')); 
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreMember/editCoreMemberSavings/"<?php echo $coremember['member_id'] ?>>
				Edit Anggota 
			</a>
		</li>
	</ul>
							...
							<div class="col-md-5">
								<table>
									...
									<!-- <tr>
										...
										<td width="5%"></td>
										<td width="60%"><input type="text" class="easyui-textbox" name="member_job" id="member_job" autocomplete="off" value="<?php echo set_value('member_job', $coremember['member_job']);?>" style="width: 100%" readonly/></td>
									</tr>
									<tr>
										<td width="35%">Identitas<span class="required">*</span></td>
										<td width="5%"></td>
										<td width="60%"><?php echo form_dropdown('member_identity', $memberidentity, set_value('member_identity',$coremember['member_identity']),'id="member_character" class="easyui-combobox" style="width: 70%"');?></td>
									</tr>
									<tr>
										<td width="35%">Nomor Identitas<span class="required">*</span></td>
										<td width="5%"></td>
										<td width="60%"><input type="text" class="easyui-textbox" name="member_identity_no" id="member_identity_no" autocomplete="off" value="<?php echo set_value('member_identity_no', $coremember['member_identity_no']);?>" style="width: 100%" readonly/></td>
									</tr>
									<tr>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('CoreMember/getListCoreMemberEdit')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

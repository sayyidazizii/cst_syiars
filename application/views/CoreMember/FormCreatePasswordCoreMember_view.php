				...
				<div class="portlet-body form">
					<div class="form-body">
						<?php
							...
							/* print_r($createpassword);
							print_r("<BR>");
							print_r("password ");
							print_r($createpassword['password']); */
						?>
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="password" id="password" autocomplete="off" style="width: 100%" value="<?php echo $createpassword['password']?>" readonly/>
										</td>
									</tr>
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="password_transaksi" id="password_transaksi" autocomplete="off" style="width: 100%" value="<?php echo $createpassword['password_transaksi']?>" readonly/>
										</td>
									</tr>
									<tr>

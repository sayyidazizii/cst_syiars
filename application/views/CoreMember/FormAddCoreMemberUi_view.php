							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td> -->
										<td width="60%">
											<!-- <input type="text" class="easyui-textbox" name="member_no" id="member_no" autocomplete="off" value="<?php echo $new_member_no;?>" style="width:50%;" readonly/>  -->
											<a href="#" role="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#memberlist">Daftar Anggota Keluar</a>
...
<div class="modal-dialog modal-lg">
	...
	<div class="modal-header">
		...
		<h4 class="modal-title">Daftar Anggota Keluar</h4>
	</div>
...
$(document).ready(function() {
	...
	table = $('#myDataTable').DataTable({ 
		...
		"ajax": {
			"url": "<?php echo site_url('CoreMember/CoreMemberOutList')?>",
			"type": "POST"
		},
		"columnDefs": [
		{ 

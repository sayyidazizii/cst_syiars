...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreMember/updateCoreMemberStatus">
									...
									foreach ($coremember as $key=>$val){									
										echo"
											<tr>			
												...
												<td>
													<a href='".$this->config->item('base_url').'CoreMember/editCoreMember/'.$val['member_id']."' class='btn default btn-xs purple'>

...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctNominativeCreditsReport">
...
<h3 class="page-title">
	Daftar Nominatif Pembiayaan<small> Kelola Daftar Nominatif Pembiayaan</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctNominativeCreditsReport/processPrinting',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					 <div class = "row">
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('kelompok_laporan_pembiayaan', $kelompoklaporansimpanan,set_value('kelompok_laporan_pembiayaan',$sesi['kelompok_laporan_pembiayaan']),'id="kelompok_laporan_pembiayaan" class="form-control select2me"');
								?>

	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoProfitSharingCheck">
				Daftar Simpanan Berjangka Dapat Bagi Hasil
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('AcctDepositoProfitSharingCheck/filter',array('id' => 'myform', 'class' => '')); 
								...
								foreach ($acctdepositoprofitsharingcheck as $key=>$val){
									...
									echo"
										<tr>			
											...
											if($val['deposito_profit_sharing_status'] == 0){
												echo "
													<td>
																	
														<a href='".$this->config->item('base_url').'AcctDepositoProfitSharingCheck/addAcctDepositoProfitSharingCheck/'.$val['deposito_profit_sharing_id']."'class='btn default btn-xs blue'>
															<i class='fa fa-plus'></i> Proses Basil
														</a>
													</td>
												";
											}

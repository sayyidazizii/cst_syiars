...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoProfitSharingCheck">
				Mutasi Harian Setoran Tunai
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<?php	echo form_open('AcctDepositoProfitSharingCheck/processUpdateAcctDepositoProfitSharing',array('id' => 'myform', 'class' => ''));  
...
$deposito_index_amount 			= $this->AcctDepositoProfitSharingCheck_model->getDepositoIndexAmount($deposito_profit_sharing_period, $acctdepositoprofitsharing['deposito_id']);
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctDepositoProfitSharingCheck" class="btn btn-default btn-sm">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<table width="100%">
								...
								<tr>
									<td width="35%">Basil</td>
									<td width="5%">:</td>
									<td width="60%">
										<input type="text" class="easyui-textbox" style="width: 100%" name="deposito_profit_sharing_amount_view" id="deposito_profit_sharing_amount_view" value="<?php echo number_format($deposito_profit_sharing_amount, 2); ?>">
...
$(document).ready(function() {
	table = $('#simpantable').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('AcctDepositoProfitSharingCheck/getAcctSavingsAccountList/'.$deposito_profit_sharing_id)?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<?php echo form_open('AcctDepositoProfitSharingNew/processAddAcctDepositoProfitSharingNew',array('id' => 'myform', 'class' => 'horizontal-form')); 
				...
				<div class="form-body">
					...
					<div class="row">
						<div class="form-actions right">
							<a href="<?php echo base_url(); ?>AcctDepositoProfitSharingNew/listdata" class="btn yellow"><i class="fa fa-bars"></i> Daftar Basil</a>

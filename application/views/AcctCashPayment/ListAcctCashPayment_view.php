...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCashPayments/indAcctCashPayment">
...
?>	
<?php	echo form_open('AcctCashPayments/filteracctcashpayment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctCashPayments/addAcctCashPayment" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCashPayments/getAcctCashPayment')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

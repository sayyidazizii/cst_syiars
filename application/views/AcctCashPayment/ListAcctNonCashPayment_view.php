...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCashPayments/indCashLessPayment">
				Daftar Angsuran Non Tunai
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('AcctCashPayments/filteracctcashlesspayment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctCashPayments/addCashlessPayment" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Angsuran Non Tunai Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCashPayments/getAcctCashLessPayment')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<?php echo form_open('AcctConsolidationReport/filterAcctProfitLoss',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">	
		...
		<div class="portlet box blue">
			<div class="portlet-body">
				...
				<div class="form-body form">
						...
						<br>
						<?php
							echo form_open('AcctConsolidationReport/processPrintingAcctProfitLoss'); 
														...
														foreach ($acctprofitlossreport_top as $key => $val) {
															...
															echo "
																...
																if($val['report_type']	== 3){
																	$account_subtotal 	= $this->AcctConsolidationReport_model->getAccountAmount($val['account_id'], $data['month_period'], $data['year_period'], $data['account_comparation_report_type'], $data['branch_id']);
					...
					<div class="row">
						<div class="col-md-12 " style="text-align  : right !important;">
							...
							<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctConsolidationReport/exportAcctProfitLossReport","_blank","top=100,left=200,width=300,height=300"));' title="Export to Excel" class="btn blue"><i class="fa fa-print"></i> Export Data  </a>
						</div>
					</div>
				</div>
			</div>

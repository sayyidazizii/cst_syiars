...
?>	
<?php	echo form_open('AcctZakatFund/filterdistribution',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctZakatFund/addAcctZakatFundDistribution" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Input Penyaluran Dana Zakat
						</span>
					</a>
				</div>
			</div>
					...
					<div class="form-body">
						<table id="myDataTable" class="table table-striped table-bordered table-hover table-full-width">
							<thead>
								<tr>
									<th width="3%">No</th>
									<th width="10%">Tanggal Penyaluran Zakat</th>
									<th width="12%">Sumber Dana</th>
									<th width="20%">Jumlah Penyaluran Zakat</th>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctZakatFund/getAcctZakatFundDistributionList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

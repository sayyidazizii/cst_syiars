...
<?php echo form_open('AcctCredits/processEditAcctCredits',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCredits/editAcctCredits/"<?php $this->uri->segment(3); ?>>
				Edit Anggota 
			</a>
		</li>
	</ul>

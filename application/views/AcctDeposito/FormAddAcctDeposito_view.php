<script>
	...
	mappia = "	<?php 
					$site_url = 'AcctDeposito/addAcctDeposito/';
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctDeposito/function_elements_add');?>",
	...
	function function_state_add(value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctDeposito/function_state_add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
	...
	function reset_data(){
		document.location = "<?php echo base_url();?>AcctDeposito/reset_data";
	}
	...
	function processAddAcctAccount() {
		...
		if(account_code == ''){
			...
			$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctDeposito/processAddAcctAccount');?>",
				data: {
...
<?php echo form_open('AcctDeposito/processAddAcctDeposito',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
	...
	if (empty($data['deposito_profit_sharing'])){
		$data['deposito_profit_sharing'] 		= '';
	}
	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDeposito">
				Daftar Kode Berjangka
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>AcctDeposito/addAcctDeposito">
				Tambah Kode Berjangka 
			</a>
		</li>
	</ul>
</div>
					...
					<div class="form-body">
						<div class="row">						
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									...
									<label class="control-label">Kode Berjangka<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<?php 
										echo form_dropdown('deposito_profit_sharing', $savingsprofitsharing, set_value('deposito_profit_sharing', $data['deposito_profit_sharing']), 'id="deposito_profit_sharing" class="form-control select2me" onChange="function_elements_add(this.name, this.value);"');
									?>
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									...
									<label class="control-label">Akun Basil</label>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									...
									<label class="control-label">Bagi Hasil / Th<span class="required">*</span></label>
								</div>
							</div>
						</div>

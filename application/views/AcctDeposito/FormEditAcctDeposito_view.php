...
<?php echo form_open('AcctDeposito/processEditAcctDeposito',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDeposito/editAcctDeposito/"<?php $this->uri->segment(3); ?>>
				Edit Kode Berjangka 
			</a>
		</li>
	</ul>
					...
					<div class="form-body">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<?php 
										echo form_dropdown('deposito_profit_sharing', $savingsprofitsharing, set_value('deposito_profit_sharing', $acctdeposito['deposito_profit_sharing']), 'id="deposito_profit_sharing" class="form-control select2me" onChange="function_elements_add(this.name, this.value);"');
									?>

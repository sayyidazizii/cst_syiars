...
<script>
	...
	function reset_edit(){
		document.location = base_url+"AcctSavingsAccountBlockir/reset_edit/<?php echo $acctsavingsaccount['member_id']?>";
	}
...
<?php echo form_open('AcctSavingsAccountBlockir/processAddAcctSavingsAccountBlockir',array('id' => 'myform', 'class' => 'horizontal-form'));
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctSavingsAccountBlockir" class="btn btn-default btn-sm">

...
<script type="text/javascript">
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctCreditsDataMutation/function_elements_add');?>",
	...
	function reset_search(){
		document.location = base_url+"AcctCreditsDataMutation/reset_search";
	}

	function processPrinting(){
		var value 				= 'print';
		var credits_account_id 	= $('#credits_account_id').val();
		var last_number 		= $('#credits_account_last_number').val();

		document.location = base_url+"AcctCreditsDataMutation/processPrinting/"+value+"/"+credits_account_id+"/"+last_number;
	}
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsDataMutation">
...
?>	
<?php	echo form_open('AcctCreditsDataMutation/filter',array('id' => 'myform', 'class' => '')); ?>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-body form">
						...
						<div class="col-md-5">
							<table width="100%">
								...
								<tr>
									...
									<td width="5%">:</td>
									<td width="60%"><input class="easyui-textbox" type="text" name="credits_account_last_number" id="credits_account_last_number"  value="<?php echo $acctcreditsaccount['credits_account_last_number'];?>"  onChange="function_elements_add(this.name, this.value);"/></td>
								</tr>
							</table>
						</div>
						<div class="col-md-1"></div>
					...
					<br>
					<?php echo form_close(); ?>
				<?php	echo form_open('AcctCreditsDataMutation/processAddAcctCreditsDataMutation',array('id' => 'myform', 'class' => '')); ?>
				<div class="portlet-body">
					<div class="form-body">
						...
						<tbody>
							<?php
								$no = 1;
								if(empty($acctcreditsaccountdetail)){
									echo "
										<tr>
									...
									foreach ($acctcreditsaccountdetail as $key=>$val){									
										echo"
										...
										<input type='text' name='".$no."_credits_payment_id' value='".$val['credits_payment_id']."' id='".$no."_credits_payment_id' class='hidden'>
											...
											<tr>			
												...
												<td>".$printstatus[$val['credits_print_status']]."</td>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCreditsDataMutation/getListAcctCreditsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsTransferMutation/getListAcctSavingsAccountTo">
...
<?php
	$sesi=$this->session->userdata('filter-listacctsavingsaccountto');

	if(!is_array($sesi)){
		$sesi['savings_id']			= '';
	}
?>	
<?php	echo form_open('AcctSavingsTransferMutation/filterListAcctSavingsAccountTo',array('id' => 'myform', 'class' => '')); ?>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsTransferMutation" class="btn btn-default btn-sm">
					...
					<tbody>
						<?php
							...
							if(empty($acctsavingsaccount)){
								...
								// $coremember = $this->session->userdata('savingsaccountfrom');
								// print_r($coremember);								
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsTransferMutation/addAcctSavingsTransferMutation/'.$savings_account_from_id.'/'.$val['savings_account_id']."' class='btn default btn-xs blue'>

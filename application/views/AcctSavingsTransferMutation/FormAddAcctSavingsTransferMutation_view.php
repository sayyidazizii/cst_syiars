...
<script>
	...
	function reset_data(){
		document.location = base_url+"AcctSavingsTransferMutation/reset_data";
	}
...
<?php echo form_open('AcctSavingsTransferMutation/processAddAcctSavingsTransferMutation',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsTransferMutation/addAcctSavingsTransferMutation">
...
$(document).ready(function() {
    ...
    var table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsTransferMutation/addAcctSavingsAccountFrom')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
$(document).ready(function() {
    ...
    var table = $('#myDataTable2').DataTable({ 
        ...
        "order": [], //Initial no order.
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsTransferMutation/addAcctSavingsAccountTo/'.$savings_account_from_id)?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

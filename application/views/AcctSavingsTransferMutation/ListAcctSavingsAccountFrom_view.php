...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsTransferMutation/getListAcctSavingsAccountFrom">
				Daftar Rekening Asal
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<?php
	$sesi=$this->session->userdata('filter-listacctsavingsaccountfrom');

	if(!is_array($sesi)){
		$sesi['savings_id']			= '';
	}
?>	
<?php	echo form_open('AcctSavingsTransferMutation/filterListAcctSavingsAccountFrom',array('id' => 'myform', 'class' => '')); ?>
								...
								// print_r($coremember);								
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsTransferMutation/addAcctSavingsAccountTo/'.$val['savings_account_id']."' class='btn default btn-xs blue'>

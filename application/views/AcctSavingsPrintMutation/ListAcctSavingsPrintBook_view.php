...
?>	
<?php	echo form_open('AcctSavingsPrintMutation/filterbook',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsPrintMutation/getListAcctSavingsAccountBook')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<script type="text/javascript">
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctSavingsPrintMutation/function_elements_add');?>",
	...
	function reset_search(){
		document.location = base_url+"AcctSavingsPrintMutation/reset_search";
	}
	...
	function processPrinting(){
		...
		document.location = base_url+"AcctSavingsPrintMutation/processPrinting/"+value+"/"+savings_account_id+"/"+last_number;
	}
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsPrintMutation">
...
?>	
<?php	echo form_open('AcctSavingsPrintMutation/filter',array('id' => 'myform', 'class' => '')); ?>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsPrintMutation/getListAcctSavingsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

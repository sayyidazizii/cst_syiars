				...
				<div class="form-body">
									...
									if($val['journal_voucher_item_id'] == $id){
										echo"
											<tr>			
												...
												<td style='text-align:left; background-color:lightgrey'>".$val['journal_voucher_no']."</td>
					...
					<div class="row">
						<div class="col-md-12 " style="text-align  : right !important;">
							<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctMemorialJournal/exportAcctMemorialJournal","_blank","top=100,left=200,width=300,height=300"));' class="btn green-jungle" title="Export to Excel">

...
?>	
<?php	echo form_open('AcctJournalVoucher/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctJournalVoucher/addAcctJournalVoucher" class="btn btn-default btn-sm">
										...
										if($val['journal_voucher_item_id'] == $id){
											echo"
												<tr>			
													...
													<td>".$status."</td>
													<td>
														<a href='".$this->config->item('base_url').'AcctJournalVoucher/prosesPrinting/'.$val['journal_voucher_id']."' class='btn default btn-xs blue'>
															<i class='fa fa-print'></i> Cetak Bukti
														</a>
														<a href='".$this->config->item('base_url').'AcctJournalVoucher/void/'.$val['journal_voucher_id']."' class='btn default btn-xs red'>

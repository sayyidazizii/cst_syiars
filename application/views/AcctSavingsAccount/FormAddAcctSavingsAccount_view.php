...
<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctSavingsAccount/function_elements_add');?>",
	...
	function reset_data(){
		document.location = base_url+"AcctSavingsAccount/reset_data";
	}
	...
	$(document).ready(function(){
		$('#savings_id').combobox({
			...
			$.post(base_url + 'AcctSavingsAccount/getSavingsAccountNo',
				{savings_id: savings_id},
				function(data){
				console.log(data);	
				var obj = $.parseJSON(data)		   
					/* $('#savings_account_no').textbox('setValue',obj["savings_account_no"]); */
...
<?php echo form_open('AcctSavingsAccount/processAddAcctSavingsAccount',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccount/addAcctSavingsAccount">
...
$(document).ready(function() {
	...
	table = $('#myDataTable').DataTable({ 
		...
		"ajax": {
			"url": "<?php echo site_url('AcctSavingsAccount/getListCoreMember')?>",
			"type": "POST"
		},
		"columnDefs": [
		{ 

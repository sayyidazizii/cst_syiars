...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsDailyMutation/addCreditsAccount">
				Mutasi Harian Pencairan Pembiayaan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<?php	echo form_open('AcctCreditsDailyMutation/processPrintingCreditsAccount',array('id' => 'myform', 'class' => ''));

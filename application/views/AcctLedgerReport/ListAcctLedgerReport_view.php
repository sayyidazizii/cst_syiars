...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctLedgerReport">
...
<h3 class="page-title">
	Laporan Buku Besar (Ledger)<small> Kelola Laporan Buku Besar (Ledger)</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctLedgerReport/processPrinting',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
					 ...
					 <div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
					 			...
					 			<label class="control-label">Nama Perkiraan
									<span class="required">
										*
									</span>
								</label>

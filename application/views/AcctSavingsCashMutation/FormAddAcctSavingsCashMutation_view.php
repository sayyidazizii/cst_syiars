...
<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctSavingsCashMutation/function_elements_add');?>",
	...
	function reset_data(){
		document.location = base_url+"AcctSavingsCashMutation/reset_data";
	}
	...
	$(document).ready(function(){
		 $('#mutation_id').combobox({
			  onChange: function(value){
			   ...
			   $.post(base_url + 'AcctSavingsCashMutation/getMutationFunction',
...
<?php echo form_open('AcctSavingsCashMutation/processAddAcctSavingsCashMutation',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsCashMutation/addAcctSavingsCashMutation">
				Tambah Mutasi Tunai Simpanan 
			</a>
		</li>
	</ul>
</div>
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctSavingsCashMutation" class="btn btn-default btn-sm">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" style="width: 100%" name="savings_cash_mutation_amount_view" id="savings_cash_mutation_amount_view" autocomplete="off" value="<?php echo set_value('savings_cash_mutation_amount',$data['savings_cash_mutation_amount']);?>"/>
									...
									<tr>
										...
										<td width="60%"><input type="text" class="easyui-datebox" style="width: 70%" name="savings_cash_mutation_date" data-options="formatter:myformatter,parser:myparser" id="savings_cash_mutation_date" autocomplete="off" value="<?php echo date('d-m-Y'); ?>"/>
										</td>
									</tr>
									<tr>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsCashMutation/getListAcctSavingsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

...
<script type="text/javascript">
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>AcctDepositoAccount/getCoreKecamatan",
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoAccount/getListCoreMember">
				Data Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('AcctDepositoAccount/filterListCoreMember',array('id' => 'myform', 'class' => '')); ?>
								...
								foreach ($coremember as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctDepositoAccount/getListAcctSavingAccount/'.$val['member_id']."' class='btn default btn-xs blue'>

...
<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctDepositoAccount/function_elements_add');?>",
	...
	function reset_data(){
		document.location = base_url+"AcctDepositoAccount/reset_data";
	}
...
<?php echo form_open('AcctDepositoAccount/processAddAcctDepositoAccount',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoAccount/addAcctDepositoAccount">
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="member_no" id="member_no" value="<?php echo $coremember['member_no'];?>" style="width: 60%" readonly autofocus/> <a href="#" role="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#memberlist">Cari Anggota</a> </td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="identity_id" id="identity_id" value="<?php if($coremember['member_identity'] != ''){ echo $memberidentity[$coremember['member_identity']];} else { echo '';}?>" style="width:100%" readonly/></td>
									</tr>
									<tr>
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="savings_account_no" id="savings_account_no" autocomplete="off" value="<?php echo $acctsavingsaccount['savings_account_no']; ?>" style="width:100%"/> <a href="#" role="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#savingsaccountlist">Cari No. Rek</a>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="deposito_period" id="deposito_period" autocomplete="off" style="width:100%"/></td>
									</tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="deposito_account_nisbah" id="deposito_account_nisbah" autocomplete="off" style="width:100%" /></td>
									</tr>
									<tr>
...
$(document).ready(function() {
	...
	var table = $('#myDataTable').DataTable({ 
		...
		"ajax": {
			"url": "<?php echo site_url('AcctDepositoAccount/getListCoreMember')?>",
			"type": "POST"
		},
		"columnDefs": [
		{ 
...
$(document).ready(function() {
	...
	var table = $('#myDataTable2').DataTable({ 
		...
		"order": [], //Initial no order.
		"ajax": {
			"url": "<?php echo site_url('AcctDepositoAccount/getListAcctSavingAccount/'.$member_id)?>",
			"type": "POST"
		},
		"columnDefs": [
		{ 

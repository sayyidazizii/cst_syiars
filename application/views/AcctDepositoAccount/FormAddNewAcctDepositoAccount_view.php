...
<?php echo form_open('AcctDepositoAccount/processAddNewAcctDepositoAccount',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width:100%"
											name="member_date_of_birth" id="member_date_of_birth" autocomplete="off" value="<?php echo $acctdepositoaccount['deposito_account_no']; ?>" readonly/></td>
									</tr>
									<tr>
										<td width="35%">Nama</td>
										<td width="5%">:</td>
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width:100%" name="deposito_period" id="deposito_period" autocomplete="off" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width:100%" name="deposito_account_no" id="deposito_account_no" autocomplete="off"  /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width:100%" name="deposito_account_nisbah" id="deposito_account_nisbah" autocomplete="off"  /></td>
									</tr>
									<tr>

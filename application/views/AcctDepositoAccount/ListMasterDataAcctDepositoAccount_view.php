...
?>	
<?php	echo form_open('AcctDepositoAccount/filtermasterdata',array('id' => 'myform', 'class' => '')); 
			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12 " style="text-align  : right !important;">
						<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctDepositoAccount/exportMasterDataAcctDepositoAccount","_blank","top=100,left=200,width=300,height=300"));' title="Export to Excel"  class="btn btn-md green-jungle"><span class="glyphicon glyphicon-print"></span> Export Data</a>
					</div>
				</div>
			</div>
		</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctDepositoAccount/getMasterDataAcctDepositoAccountList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

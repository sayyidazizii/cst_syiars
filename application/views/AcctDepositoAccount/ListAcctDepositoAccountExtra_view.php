...
?>	
<?php	echo form_open('AcctDepositoAccount/filterAcctDepositoAccountDueDate',array('id' => 'myform', 'class' => '')); 
								...
								foreach ($acctdepositoaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctDepositoAccount/addAcctDepositoAccountExtra/'.$val['deposito_account_id']."' class='btn default btn-xs green-jungle'>

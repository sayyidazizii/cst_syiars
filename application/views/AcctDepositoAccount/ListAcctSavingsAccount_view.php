...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoAccount/getListAcctSavingsAccount">
...
?>	
<?php	echo form_open('AcctDepositoAccount/filterListAcctSavingsAccount',array('id' => 'myform', 'class' => '')); ?>
								...
								// print_r($coremember);								
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctDepositoAccount/addAcctDepositoAccount/'.$member_id.'/'.$val['savings_account_id']."' class='btn default btn-xs blue'>

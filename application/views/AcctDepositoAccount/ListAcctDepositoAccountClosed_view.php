...
?>	
<?php	echo form_open('AcctDepositoAccount/filterClosedAcctDepositoAccount',array('id' => 'myform', 'class' => '')); 
									...
									echo"
										<tr>			
											...
											if($val['deposito_account_blockir_status'] == 0){
												echo "
													<td>
														<a href='".$this->config->item('base_url').'AcctDepositoAccount/addClosedAcctDepositoAccount/'.$val['deposito_account_id']."' class='btn default btn-xs yellow'>

...
?>	
<?php	echo form_open('AcctDepositoAccount/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctDepositoAccount/addAcctDepositoAccount" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctDepositoAccount/getListAcctDepositoAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

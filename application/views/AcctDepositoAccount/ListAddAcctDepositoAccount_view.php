...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDepositoAccount/listAcctDepositoAccount">
...
?>	
<?php	echo form_open('AcctDepositoAccount/filterListAcctDepositoAccount',array('id' => 'myform', 'class' => '')); 
								...
								foreach ($acctdepositoaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctDepositoAccount/addNewAcctDepositoAccount/'.$val['deposito_account_id']."' class='btn default btn-xs blue'>

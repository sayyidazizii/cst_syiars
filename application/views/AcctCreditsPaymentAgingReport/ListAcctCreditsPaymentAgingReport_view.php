...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsPaymentAgingReport">
				Daftar Pembiayaan Jatuh Tempo
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<h3 class="page-title">
	Daftar Pembiayaan Kurang Lancar<small> Kelola Daftar Pembiayaan Kurang Lancar</small>
</h3>
<?php
	...
	if (empty($sesi['credits_aging_id'])){
		$sesi['credits_aging_id'] = 0;
	}
...
?>	
<?php	
	echo form_open('AcctCreditsPaymentAgingReport/processPrinting',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					...
					<div class = "row">
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('credits_aging_id', $corecreditsaging, set_value('credits_aging_id', $sesi['credits_aging_id']), 'id="credits_aging_id" class="form-control select2me" ');
								?>
								<label>Kriteria Keterlambatan</label>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group form-md-line-input">

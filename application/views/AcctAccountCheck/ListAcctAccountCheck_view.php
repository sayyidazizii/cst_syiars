...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctAccount">
				Daftar Perkiraan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		...
		<div class="col-md-12">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctAccount/addAcctAccount" class="btn btn-default btn-sm">
									...
									foreach ($acctaccount as $key=>$val){									
										echo"
											<tr>			
												...
												<td>
													<a href='".$this->config->item('base_url').'AcctAccount/editAcctAccount/'.$val['account_id']."' class='btn default btn-xs purple'>
														<i class='fa fa-edit'></i> Edit
													</a>
													<a href='".$this->config->item('base_url').'AcctAccount/deleteAcctAccount/'.$val['account_id']."'class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>

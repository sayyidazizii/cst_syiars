...
?>	
<?php	echo form_open('AcctCreditAccount/filteracctcreditsaccount',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctCreditAccount/addform" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Pembiayaan Baru
						</span>
					</a>
				</div>
			</div>
				...
				<div class="form-body">
					...
					<thead>
						<tr>
							...
							<th width="10%">Jumlah Pembiayaan</th>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCreditAccount/getAcctCreditsAccountList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

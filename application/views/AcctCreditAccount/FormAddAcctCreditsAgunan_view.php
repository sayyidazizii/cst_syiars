...
<script>
	...
	mappia = "	<?php 
					...
					$site_url = 'AcctCreditAccount/addform/'.$id;
	...
	function processAddArrayAgunan(){
		...
		var shm_keterangan 		= document.getElementById("shm_keterangan").value;
			...
			$('#onspinspinwarehouse').css('display', 'table-row');
			  $.ajax({
			  type: "POST",
			  url : "<?php echo site_url('AcctCreditAccount/processAddArrayAgunan');?>",
			  data: {
					'tipe' 					: tipe,	
		...
		<!-- <?php echo form_open('AcctCreditAccount/processAddArrayAgunan',array('id' => 'myform', 'class' => 'horizontal-form')); ?> -->
		<div class="form-body">

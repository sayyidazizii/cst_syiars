...
<?php echo form_open('PreferenceIncome/processAddPreferenceIncome',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				...
				<div class="portlet-body">
					<div class="form-body">
						<?php
							echo form_open('PreferenceIncome/processEditPreferenceIncome'); 
											...
											echo "
												...
												<tr>
													...
													if($val['income_status'] == 0){
														echo "
															<td><a href='".$this->config->item('base_url').'PreferenceIncome/deletePreferenceIncome/'.$val['income_id']."' class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>

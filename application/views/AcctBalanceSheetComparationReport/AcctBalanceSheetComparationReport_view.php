							...
							<thead>
								<tr>
									<td colspan='4' style='text-align:center;'>
										<div style='font-weight:bold'>LAPORAN KOMPARASI NERACA</div>
									</td>
								</tr>
								<tr>
									<td colspan='4' style='text-align:center;'>
												...
												foreach ($acctbalancesheetcomparationreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
												...
												foreach ($acctbalancesheetcomparationreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($val['account_id2'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
																...
																for($i = 0; $i < count($report_formula3); $i++){
																	if($report_operator3[$i] == '-'){
																		...
																		if($total_account_amount1_before == 0){
																			...
																			$total_account_amount1_top = $total_account_amount1_top + $account_amount1_before[$report_formula3[$i]];
																		}
																	}
																}
															}
											...
											<?php
												foreach ($acctbalancesheetcomparationreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($val['account_id1'], $month_now, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
											...
											<?php
												foreach ($acctbalancesheetcomparationreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance($val['account_id2'], $month_now, $year_now, $data['account_comparation_report_type'], $data['branch_id']);

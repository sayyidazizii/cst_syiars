...
<?php echo form_open('AcctBalanceSheetReportNew/filtercheck',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">	
												...
												foreach ($acctbalancesheetreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															...
															$acctaccountlist 	= $this->AcctBalanceSheetReportNew_model->getAcctAccount_List($length, $val['account_code1']);
															...
															if(!empty($acctaccountlist)){
																foreach ($acctaccountlist as $ka => $va){
																	$last_balance 	= $this->AcctBalanceSheetReportNew_model->getLastBalance($va['account_id'], $data['branch_id'], $last_month, $last_year);

																	$mutation 		= $this->AcctBalanceSheetReportNew_model->getMutation($va['account_id'], $start_date, $end_date, $data['branch_id']);

																	$amount 		= ($last_balance + $mutation['account_in_amount']) - $mutation['account_out_amount'];

																	$last_balance1 	= $last_balance1 + $amount;
										
																	echo "
																	<tr>
																		<td><div style='font-weight:".$report_bold1."'>".$report_tab1."(".$va['account_code'].") ".$va['account_name']."</div> </td>
																		<td style='text-align:right'><div style='font-weight:".$report_bold1."'>".number_format($amount, 2)."</div></td>
																	</tr>";
												...
												foreach ($acctbalancesheetreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															...
															$acctaccountlist 	= $this->AcctBalanceSheetReportNew_model->getAcctAccount_List($length, $val['account_code2']);
															...
															if(!empty($acctaccountlist)){
																foreach ($acctaccountlist as $ka => $va){
																	...
																	$last_balance2 	= $last_balance2 + $amount;
										
																	echo "
																	<tr>
																		<td><div style='font-weight:".$report_bold2."'>".$report_tab2."(".$va['account_code'].") ".$va['account_name']."</div> </td>
																		<td style='text-align:right'><div style='font-weight:".$report_bold2."'>".number_format($amount, 2)."</div></td>
																	</tr>";
													...
													echo "
														...
														if($val['report_type2']	==8){
															...
															$pembagian_shu_tahun_lalu	= $this->AcctBalanceSheetReportNew_model->getPembagianSHUTahunLalu($data['branch_id'], $end_date);

															// print_r("aaaa ".$pembagian_shu_tahun_lalu);
													...
													echo "
														...
														if($val['report_type2']	== 7){
															...
															echo "
																<td><div style='font-weight:".$report_bold2."'>".$report_tab2."(".$val['account_code2'].") ".$val['account_name2']."</div> </td>
																<td style='text-align:right'><div style='font-weight:".$report_bold2."'>".number_format($profitloss, 2)."</div></td>
															";

															$account_amount2_bottom[$val['report_no']] = $profitloss;

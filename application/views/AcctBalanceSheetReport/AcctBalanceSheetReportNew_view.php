												...
												foreach ($acctbalancesheetreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	==8){
															...
															$pembagian_shu_tahun_lalu	= $this->AcctBalanceSheetReportNew_model->getPembagianSHUTahunLalu($data['branch_id'], $last_month, $last_year);

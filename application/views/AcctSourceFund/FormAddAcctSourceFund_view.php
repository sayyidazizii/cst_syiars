...
<?php echo form_open('AcctSourceFund/processAddAcctSourceFund',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSourceFund/addAcctSourceFund">
				Tambah Sumber Dana 
			</a>
		</li>
	</ul>

<script>
    ...
    $(document).ready(function(){
        $("#kecamatan_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>CoreDusun/getCoreKelurahan",
...
<?php echo form_open('CoreDusun/processAddCoreDusun',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreDusun/addCoreDusun">
				Tambah Dusun
			</a>
		</li>
	</ul>

...
<script>
	...
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>CoreDusun/getCoreKecamatan",
    ...
    $(document).ready(function(){
        $("#kecamatan_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>CoreDusun/getCoreKeluarahan",
...
?>	
<?php	echo form_open('CoreDusun/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>CoreDusun/addCoreDusun" class="btn btn-default btn-sm">
									...
									foreach ($coredusun as $key=>$val){									
										echo"
											<tr>			
												...
												<td>
													<a href='".$this->config->item('base_url').'CoreDusun/editCoreDusun/'.$val['dusun_id']."' class='btn default btn-xs purple'>
														<i class='fa fa-edit'></i> Edit
													</a>
													<a href='".$this->config->item('base_url').'CoreDusun/deleteCoreDusun/'.$val['dusun_id']."'class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>

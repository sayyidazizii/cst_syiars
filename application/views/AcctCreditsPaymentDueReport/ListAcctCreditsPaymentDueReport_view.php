...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsPaymentDueReport">
...
<h3 class="page-title">
	Daftar Pembiayaan Jatuh Tempo<small> Kelola Daftar Pembiayaan Jatuh Tempo</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctCreditsPaymentDueReport/processPrinting',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">

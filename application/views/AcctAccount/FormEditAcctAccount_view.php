...
<?php echo form_open('AcctAccount/processEditAcctAccount',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctAccount/editAcctAccount/"<?php $this->uri->segment(3); ?>>
				Edit Perkiraan 
			</a>
		</li>
	</ul>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctAccount" class="btn btn-default btn-sm">

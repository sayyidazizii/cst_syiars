...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url+"AcctPaymentPrintMutation/reset_search";
	}
	...
	function processPrinting(){
		...
		document.location = base_url+"AcctPaymentPrintMutation/processPrinting/"+value+"/"+credits_account_id+"/"+last_number;
	}
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctPaymentPrintMutation">
...
?>	
<?php	echo form_open('AcctPaymentPrintMutation/filter',array('id' => 'myform', 'class' => '')); ?>
						...
						<div class="col-md-5">
							<table width="100%">
								...
								<tr>
									...
									<td width="5%">:</td>
									<td width="60%"><input class="easyui-textbox" type="text" name="credits_account_last_number" id="credits_account_last_number"  value="<?php echo $acctcreditsaccount['credits_account_last_number'];?>"/></td>
								</tr>
							</table>
						</div>
						<div class="col-md-1"></div>

										...
										foreach ($acctdepositoaccountblockir as $key => $val) {
											echo "
												<tr>
													...
													<td>
														<a href='".$this->config->item('base_url').'AcctDepositoAccountBlockir/addAcctDepositoAccountUnBlockir/'.$val['deposito_account_blockir_id']."' class=' btn btn-sm red'><i class='fa fa-edit'></i> UnBlock</a>
													</td>
												</tr>
											";
										}
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctDepositoAccountBlockir/getAcctDepositoAccountUnBlockirList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

		...
		<div class="col-md-12">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctDepositoAccountBlockir/addAcctDepositoAccountBlockir" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctDepositoAccountBlockir/getAcctDepositoAccountBlockirList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

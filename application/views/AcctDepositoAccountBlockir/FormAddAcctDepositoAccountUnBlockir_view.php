...
<script>
	...
	function function_elements_edit(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctDepositoAccountBlockir/function_elements_edit');?>",
	...
	function reset_edit(){
		document.location = base_url+"AcctDepositoAccountBlockir/reset_edit/<?php echo $acctdepositoaccountblocker['member_id']?>";
	}
...
<?php echo form_open('AcctDepositoAccountBlockir/processAddAcctDepositoAccountUnBlockir',array('id' => 'myform', 'class' => 'horizontal-form'));?>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctDepositoAccountBlockir/unBlockirAcctDepositoAccount" class="btn btn-default btn-sm">

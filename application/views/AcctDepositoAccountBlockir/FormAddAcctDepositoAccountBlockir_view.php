...
<script>
	...
	function reset_edit(){
		document.location = base_url+"AcctDepositoAccountBlockir/reset_edit/<?php echo $acctdepositoaccount['member_id']?>";
	}
...
<?php echo form_open('AcctDepositoAccountBlockir/processAddAcctDepositoAccountBlockir',array('id' => 'myform', 'class' => 'horizontal-form'));

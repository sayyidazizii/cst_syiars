...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsPaymentReport">
				Daftar Tagihan Pembiayaan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<h3 class="page-title">
	Daftar Tagihan Pembiayaan<small> Kelola Daftar Tagihan Pembiayaan</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctCreditsPaymentReport/processPrinting',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">

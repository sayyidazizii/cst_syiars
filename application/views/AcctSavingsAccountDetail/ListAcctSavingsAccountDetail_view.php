...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsAccountDetail">
...
?>	
<?php	echo form_open('AcctSavingsAccountDetail/filter',array('id' => 'myform', 'class' => '')); 
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsAccountDetail/getListAcctSavingsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

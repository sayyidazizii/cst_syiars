...
?>	
<?php	echo form_open('AcctCreditAccount/filteracctcreditsaccountbook',array('id' => 'myform', 'class' => '')); 
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCreditAccount/getAcctCreditsAccountBookList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

								...
								<table style="width: 100%;" border="0" padding="0" >
									<tbody>
										...
										<tr>
											...
											<td width="5%">:</td>
											<td width="60%">
												<input type="text" disabled class="easyui-textbox" name="identity_name" id="identity_name" value="" style="width: 100%" readonly/>
											</td>
										</tr>
										<tr>
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="new_credits_account_margin_amount_view" id="new_credits_account_margin_amount_view" value="<?php echo number_format($credit_account['credits_account_margin_amount'], 2);?>" style="width: 100%" disabled/>
										</td>
									</tr>
									<tr>

            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(<?php echo base_url();?>/assets/pages/img/login/bg1.png)">
                        <img class="login-logo" src="<?php echo base_url();?>assets/pages/img/login/logovisidata.png" height="10%" width = "50%" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">

                        <h1>SIS <br>Syariah Integrated System</h1>
                       <!--  <p>Welcome to Assets Management System --> <!-- <br> Customized for Keisha Chemicals</p> -->
                        ...
                        <div class="row bs-reset">
                            <div class="col-xs-12 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; VisiData 2019. Powered by Metronic Admin Template</p>
                                </div>
                            </div>
                        </div>
                    </div>

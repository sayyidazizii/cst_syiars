...
<script>
	...
	function reset_edit(){
		document.location = base_url+"CoreMember/reset_edit_create_password/<?php echo $coremember['member_id']?>";
	}
...
<?php echo form_open('CoreMemberPassword/processCreatePasswordCoreMember',array('id' => 'myform', 'class' => 'horizontal-form')); 
?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreMemberPassword/createPasswordCoreMember/"<?php echo $coremember['member_id'] ?>>
				Buat Password
			</a>
		</li>
	</ul>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>CoreMemberPassword" class="btn btn-default btn-sm">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										<td width="35%">Password<span class="required" style="color:red;">*</span></td>
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="password" id="password" autocomplete="off" value="" style="width: 100%"/>
										</td>
									</tr>
									<tr>
										<td width="35%">Password Transaksi<span class="required" style="color:red;">*</span></td>
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="password_transaksi" id="password_transaksi" autocomplete="off" value="" style="width: 100%"/>
										</td>
									</tr>
									<tr>

...
<?php
	...
	$data 		= $this->session->userdata('filter-acctdepositoprofitsharingreport');
	$year_now 	=	date('Y');
	if(!is_array($data)){
	...
	// print_r($data); exit;
?> 
<?php	echo form_open('AcctDepositoProfitSharingReport/filter',array('id' => 'myform', 'class' => '')); 
?>
<h3 class="page-title">
	Daftar Basil Simpanan Berjangka
</h3>
<div class="row">
	<div class="col-md-12">
					...
					<div class="form-body">
						...
						<thead>
							<tr>
								...
								<th style="text-align: center; width: 12%">No. SimpKa</th>
								<th style="text-align: center; width: 15%">Nama</th>
								<th style="text-align: center; width: 20%">Alamat</th>
								<th style="text-align: center; width: 12%">Deposito</th>
      		...
      		<table>
				...
				$no =1;
					...
					for ($i=0; $i < $file ; $i++) {  ?>
						...
						<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctDepositoProfitSharingReport/view/<?php echo $file; ?>/<?php echo $i; ?>","_blank"));' title="View" class="btn btn-md green-jungle"><span class="glyphicon glyphicon-print"></span> View Data File Ke <?php echo $no; ?></a>
						<br>
						<br>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctDepositoProfitSharingReport/getDepositoProfitSharing')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsCashMutationBranch">
				Daftar Mutasi Simpanan (Antar Cabang)
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('AcctSavingsCashMutationBranch/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsCashMutationBranch/addAcctSavingsCashMutationBranch" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsCashMutationBranch/getAcctSavingsCashMutationBranch')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

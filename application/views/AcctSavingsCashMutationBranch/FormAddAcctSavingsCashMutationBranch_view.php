...
<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('AcctSavingsCashMutationBranch/function_elements_add');?>",
	...
	function reset_data(){
		document.location = base_url+"AcctSavingsCashMutationBranch/reset_data";
	}
	...
	$(document).ready(function(){
		 $('#mutation_id').combobox({
			  onChange: function(value){
			   ...
			   $.post(base_url + 'AcctSavingsCashMutationBranch/getMutationFunction',
...
<?php echo form_open('AcctSavingsCashMutationBranch/processAddAcctSavingsCashMutationBranch',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsCashMutationBranch">
				Daftar Mutasi Simpanan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>AcctSavingsCashMutationBranch/addAcctSavingsCashMutationBranch">
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctSavingsCashMutationBranch" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsCashMutationBranch/getListAcctSavingsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

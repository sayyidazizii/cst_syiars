...
<h3 class="page-title">
	Form Pembatalan Mutasi Simpanan
</h3>
<?php
// print_r($data);
				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">						
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="city_name" id="city_name" value="<?php echo $acctsavingscashmutation['city_name']; ?>" readonly/>
									<label class="control-label">Kabupaten<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="kecamatan_name" id="kecamatan_name" value="<?php echo $acctsavingscashmutation['kecamatan_name']; ?>" readonly/>
						...
						<div class="row">						
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="identity_name" id="identity_name" value="<?php echo $acctsavingscashmutation['identity_name']; ?>" readonly/>
...
<?php echo form_open('AcctSavingsCashMutation/processVoidAcctSavingsCashMutation',array('id' => 'myform', 'class' => 'horizontal-form'));
?>
<script>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Membatalkan Mutasi Simpanan Tunai</h4>
				</div>

...
?>	
<?php	echo form_open('AcctSavingsCashMutation/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsCashMutation/addAcctSavingsCashMutation" class="btn btn-default btn-sm">
								...
								foreach ($acctsavingsmutation as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsCashMutation/voidAcctSavingsCashMutation/'.$val['savings_cash_mutation_id']."'class='btn default btn-xs red'>

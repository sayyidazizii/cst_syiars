...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCashPaymentsBranch/addAcctCashPayment">
...
<?php echo form_open('AcctCashPaymentsBranch/processAddAcctCashPayment',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctCashPaymentsBranch/indAcctCashPayment" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#akadtable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCashPaymentsBranch/akadlisttunai')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

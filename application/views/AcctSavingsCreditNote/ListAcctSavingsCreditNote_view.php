...
?>	
<?php	echo form_open('AcctSavingsCreditNote/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsCreditNote/addAcctSavingsCreditNote" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Nota Kredit Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsCreditNote/getAcctSavingsCreditNote')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

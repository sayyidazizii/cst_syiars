...
<script type="text/javascript">
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>AcctSavingsCashMutation/getCoreKecamatan",
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsCashMutation/getListCoreMember">
				Data Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('AcctSavingsCashMutation/filterListAcctSavingsAccount',array('id' => 'myform', 'class' => '')); ?>
								...
								foreach ($acctsavingsaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsCashMutation/addAcctSavingsCashMutation/'.$val['savings_account_id']."' class='btn default btn-xs blue'>

...
<?php echo form_open('AcctSavings/processEditAcctSavings',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavings/editAcctSavings/"<?php $this->uri->segment(3); ?>>
				Edit Anggota 
			</a>
		</li>
	</ul>
				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<?php echo form_dropdown('account_basil_id', $acctaccount, set_value('account_id',$acctsavings['account_basil_id']),'id="account_basil_id" class="form-control select2me" ');?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="savings_nisbah" id="savings_nisbah" autocomplete="off" value="<?php echo set_value('savings_nisbah',$acctsavings['savings_nisbah']);?>" />
									<label class="control-label">Nisbah<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="savings_basil" id="savings_basil" autocomplete="off" value="<?php echo set_value('savings_basil',$acctsavings['savings_basil']);?>" />

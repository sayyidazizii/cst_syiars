...
<h3 class="page-title">
	Form Pembatalan  Mutasi Setoran Simpanan Non Tunai
</h3>
<?php
// print_r($data);
...
<?php echo form_open('AcctSavingsBankMutation/processVoidAcctSavingsBankMutation',array('id' => 'myform', 'class' => 'horizontal-form'));
?>
<script>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Membatalkan Setoran Simpanan Non Tunai</h4>
				</div>

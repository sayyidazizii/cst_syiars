	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsBankMutation">
				Daftar Mutasi Setoran Simpanan Non Tunai
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<h3 class="page-title">
	Daftar Mutasi Setoran Simpanan Non Tunai<small>Kelola Mutasi Simpanan Non Tunai</small>
</h3>
<?php
...
?>	
<?php	echo form_open('AcctSavingsBankMutation/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsBankMutation/addAcctSavingsBankMutation" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Mutasi Setoran Simpanan Non Tunai Baru
						</span>
					</a>
				</div>
			</div>

<script>
	...
	$(document).ready(function(){
        $("#savings_account_id").change(function(){
            ...
            $.post(base_url + 'AcctSavingsBankMutation/getAcctSavingsAccount_Detail',
...
<?php echo form_open('AcctSavingsBankMutation/processAddAcctSavingsBankMutation',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsBankMutation">
				Daftar Mutasi Simpanan Non Tunai
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>AcctSavingsBankMutation/addAcctSavingsBankMutation">
				Tambah Mutasi Simpanan Non Tunai 
			</a>
		</li>
	</ul>
</div>
...
<h3 class="page-title">
	Form Tambah Mutasi Simpanan Non Tunai
</h3>
<?php
// print_r($data);
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctSavingsBankMutation" class="btn btn-default btn-sm">

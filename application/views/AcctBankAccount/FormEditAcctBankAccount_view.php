...
<?php echo form_open('AcctBankAccount/processEditAcctBankAccount',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctBankAccount/editAcctBankAccount/"<?php $this->uri->segment(3); ?>>
				Edit Kode Bank 
			</a>
		</li>
	</ul>

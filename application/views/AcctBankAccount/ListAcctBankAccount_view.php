		...
		<div class="col-md-12">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctBankAccount/addAcctBankAccount" class="btn btn-default btn-sm">
									...
									foreach ($acctbankaccount as $key=>$val){									
										echo"
											<tr>			
												...
												<td>
													<a href='".$this->config->item('base_url').'AcctBankAccount/editAcctBankAccount/'.$val['bank_account_id']."' class='btn default btn-xs purple'>
														<i class='fa fa-edit'></i> Edit
													</a>
													<a href='".$this->config->item('base_url').'AcctBankAccount/deleteAcctBankAccount/'.$val['bank_account_id']."'class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>

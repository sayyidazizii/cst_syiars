<script>
	...
	$(document).ready(function(){
        $("#branch_parent_id").change(function(){
		  ...
		  $.post(base_url + 'CoreBranch/getBranchName',
...
<?php echo form_open('CoreBranch/processEditCoreBranch',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreBranch/editCoreBranch/"<?php $this->uri->segment(3); ?>>
				Edit Cabang 
			</a>
		</li>
	</ul>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									...
									<label class="control-label">Kepala Cabang<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="branch_no_sk" id="branch_no_sk" autocomplete="off" value="<?php echo set_value('branch_no_sk',$corebranch['branch_no_sk']);?>"/>
									<label class="control-label">NO. SK<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-12">	
								<div class="form-group form-md-line-input">

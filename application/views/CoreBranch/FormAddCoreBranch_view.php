...
<?php echo form_open('CoreBranch/processAddCoreBranch',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="branch_no_sk" id="branch_no_sk" autocomplete="off" value="<?php echo set_value('branch_no_sk',$data['branch_no_sk']);?>"/>

...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsPrintSavingsMonitor">
				Master Data Rekening Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('AcctSavingsPrintSavingsMonitor/filterAcctSavingsAccount',array('id' => 'myform', 'class' => '')); ?>
...
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					Daftar Rekening Anggota
				</div>
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsPrintSavingsMonitor" class="btn btn-default btn-sm">
								...
								foreach ($acctsavingsaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>".$this->AcctSavingsPrintSavingsMonitor_model->getCityName($val['city_id'])."</td>
											<td>".$this->AcctSavingsPrintSavingsMonitor_model->getKecamatanName($val['kecamatan_id'])."</td>
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsPrintSavingsMonitor/getListAcctSavingsMonitor/'.$val['savings_account_id']."' class='btn default btn-xs blue'>

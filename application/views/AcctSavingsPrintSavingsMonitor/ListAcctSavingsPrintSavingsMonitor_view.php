...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url+"AcctSavingsPrintSavingsMonitor/reset_search";
	}
</script>
<div class="row-fluid">
...
?>	
<?php	echo form_open('AcctSavingsPrintSavingsMonitor/filter',array('id' => 'myform', 'class' => '')); ?>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					Monitor Simpanan - Rekening Koran Simpanan
				</div>
				<!-- <div class="tools">
			...
			<div class="portlet-body">
				<div class="form-body form">
					...
					<?php echo form_close(); ?>
				<?php
					echo form_open('AcctSavingsPrintSavingsMonitor/processPrinting'); 
				?>
				<input class="easyui-textbox" type="hidden" name="savings_account_id" id="savings_account_id"  value="<?php echo $acctsavingsaccount['savings_account_id'];?>"/>
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							<div class="col-md-12 " style="text-align  : right !important;">
								...
								<a href='<?php echo base_url(); ?>AcctSavingsPrintSavingsMonitor/SyncronizeData' class='btn btn-md red'> Syncronize Data </a>	
							</div>
						</div>
					</div>
				</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctSavingsPrintSavingsMonitor/getListAcctSavingsAccount')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 

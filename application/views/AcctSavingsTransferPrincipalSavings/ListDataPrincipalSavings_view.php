...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctSavingsTransferPrincipalSavings">
				...
				<div class="form-body">
					...
					<div class="row">
						<div class="form-actions right">
							<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctSavingsTransferPrincipalSavings/export","_blank","top=100,left=200,width=300,height=300"));' title="Export to Excel" class="btn btn-md green-jungle"><span class="glyphicon glyphicon-print"></span> Export Data</a>
						</div>	
					</div>
